...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 136996, 202800, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (339796)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (2)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (136996)
#define AI_NETWORK_DATA_ACTIVATION_2_SIZE    (202800)
...
extern ai_handle g_network_activations_table[2 + 2];
